...
public class ToDoFragment extends Fragment {
    ...
    private Button btn_sortPriority;
    private Button btn_sortDateTime;
    private Button btn_sortNone;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_sortPriority = view.findViewById(R.id.btn_priority);
        btn_sortDateTime = view.findViewById(R.id.btn_date_time);
        btn_sortNone = view.findViewById(R.id.btn_none);
        ...
        btn_sortPriority.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toDoList.clear();
                readAllTodoTableSortedByPriority();
                toDoAdapter.notifyDataSetChanged();
            }
        });

        btn_sortDateTime.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toDoList.clear();
                readAllTodoTableSortedByDateTime();
                toDoAdapter.notifyDataSetChanged();
            }
        });

        btn_sortNone.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                toDoList.clear();
                readAllTodoTable();
    ...
    private void addToDo(Cursor cursor){
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                String backgroundColor = cursor.getString(14);
    ...
    private void readAllTodoTableSortedByPriority(){

        Cursor cursor = dbHelper.readAllUserTodoTableSortedByPriority(loggedInUser);
        addToDo(cursor);
    }

    private void readAllTodoTableSortedByDateTime(){

        Cursor cursor = dbHelper.readAllUserTodoTableSortedByDateTime(loggedInUser);
        addToDo(cursor);
    }
